...
SELECT *, DATENAME(WEEKDAY, hire_date) as day FROM @Employee
WHERE DATENAME(WEEKDAY, hire_date) IN ('Saturday','Sunday')


/*
EmployeeID	FirstName	LastName	deparmentID		Salary	hire_date	day
---------------------------------------------------------------------------------
1			Adam		Owens	1	00				30000	2024-11-02	Saturday
*/